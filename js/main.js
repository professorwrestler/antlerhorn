class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("playerAnimated", "./assets/playerAnimated.png", {
      frameWidth: 16,
      frameHeight: 32,
    });
  ...
  create() {
    ...
    this.ui = this.add
      .tileSprite(0, 0, this.game.config.width, this.game.config.height, "ui")
      .setOrigin(0, 0);

    //some ui text
    this.add.text(8, 200, "Life: ", {
      fontFamily: "Brush Script MT",
      fontSize: 14,
      color: "rgb(209,184,184)",
    });
    //some score text
    this.add.text(150, 200, "Score: ", {
      fontFamily: "Brush Script MT",
      fontSize: 14,
      color: "rgb(209,184,184)",
    });
    //add score
    this.scoreBoard = this.add.text(186, 201, `${this.score}`, {
      fontFamily: "Brush Script MT",
      fontSize: 14,
      color: "rgb(209,184,184)",
    });
    ...
    const flyAnimation = this.anims.create({
      key: "fly",
      frames: this.anims.generateFrameNumbers("playerAnimated", {
        start: 0,
        end: 1,
      }),
      frameRate: 10,
    ...
    //Adding the enemies here.
    /*
      I'll redo this with a for loop
      when I add some more enemy
      variation.
     */
  ...
  update() {
    ...
    this.background1.tilePositionX += 0.8;
